...
if (perguntaUm == 'S'){
  ...
  console.log(`A resposta foi: ${perguntaUm} = ("NÃO"), você ganhou 0 pontos.`);
}
console.log();
...
if (perguntaDois == 'S'){
  ...
  console.log(`A resposta foi: ${perguntaDois} = ("NÃO"), você ganhou 0 pontos.`);
}
console.log();
...
console.log('<<- FASE 03 ->>');
let perguntaTrês = prompt('Mario BROSS, você se despediu de Luigi? [s/n]: ').toUpperCase()
if (perguntaTrês == 'S'){
  console.log(`A resposta foi: ${perguntaTrês}IM, você ganhou 1 ponto.`);
  respostaSim ++
}else{
  console.log(`A resposta foi: ${perguntaTrês} = ("NÃO"), você ganhou 0 pontos.`);
}
console.log();
...
if (perguntaQuatro == 'S'){
  ...
  console.log(`A resposta foi: ${perguntaQuatro} = ("NÃO"), você ganhou 0 pontos.`);
}
console.log();
...
if (perguntaCinco == 'S'){
  ...
  console.log(`A resposta foi: ${perguntaCinco} = ("NÃO"), você ganhou 0 pontos.`);
}
console.log();
